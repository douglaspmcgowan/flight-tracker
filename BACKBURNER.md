...
|---|---|---|---|---|---|
| python-312-runtime-missing | Declared sidecar verification requires Python 3.12 but the workstation currently exposes only Python 3.13 and 3.14 | project-operations | handoff-completion | D1 | closed |
